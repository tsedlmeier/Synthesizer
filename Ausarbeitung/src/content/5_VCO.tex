...
\begin{figure}[h]
	...
	\setlength{\fboxsep}{1pt} %Abstand der Linien zur Abbildung
	\setlength{\fboxrule}{1pt} %Dicke der Linie
	\fbox{\includegraphics[width=0.4\textwidth]{figures/VCO_Leiterplatte_gefraest}}
...
\begin{figure}[h]
	...
	\setlength{\fboxsep}{1pt} %Abstand der Linien zur Abbildung
	\setlength{\fboxrule}{1pt} %Dicke der Linie
	\fbox{\includegraphics[width=0.65\textwidth]{figures/VCO_Frontplatte_schraeg}}
...
%	\setlength{\fboxsep}{1pt} %Abstand der Linien zur Abbildung
%	\setlength{\fboxrule}{1pt} %Dicke der Linie
%	\fbox{\includegraphics[width=0.35\textwidth]{figures/VCO_Frontplatte_oben}}
%	\caption{VCO Frontplatte, Vorderansicht}
%	\label{fig:VCO Frontplatte}
%\end{figure}
